...
export interface Env { DATABASE_URL?: string; DB: D1Database; TMDB_BEARER_TOKEN?: string; ADMIN_TOKEN?: string; CALENDAR_TOKEN?: string; MOVIE_REGION?: string; TMDB_LANGUAGE?: string; MOVIE_WINDOW_DAYS?: string; TVMAZE_PAGES_PER_SYNC?: string; TMDB_PAGES_PER_SYNC?: string; }
